...
| Coding Agent V1 横向产品架构 | 已冻结；Product-Layer M0–M3 Accepted/完成；M4–M7 inactive | [`m3-instruction-context-design.md`](./m3-instruction-context-design.md)、[`evidence/m3-implementation-verification-2026-09-23.md`](./evidence/m3-implementation-verification-2026-09-23.md)、[`target-architecture-snapshot.md`](./target-architecture-snapshot.md)、[`architecture-consistency-audit.md`](./architecture-consistency-audit.md)、[`coding-agent-v1-implementation-roadmap.md`](./coding-agent-v1-implementation-roadmap.md)、[`v1-development-capability-matrix.md`](./v1-development-capability-matrix.md)、[completed M3 milestone execution contract](./execution-contracts/m3-execution-contract.md) |
...
6. [`coding-agent-v1-implementation-roadmap.md`](./coding-agent-v1-implementation-roadmap.md)：M0–M3 已 Accepted/完成、M4–M7 未激活的实施 DAG；
...
10. [completed M3 milestone execution contract](./execution-contracts/m3-execution-contract.md)：M3 instruction/context/frozen-request 封闭范围、Schema v7、验收与停机条件；
11. [`m3-instruction-context-design.md`](./m3-instruction-context-design.md) 与 [`evidence/m3-implementation-verification-2026-09-23.md`](./evidence/m3-implementation-verification-2026-09-23.md)：M3 physical design、实现边界与 owner acceptance 的可复现验证；
12. [`v1-development-capability-matrix.md`](./v1-development-capability-matrix.md)：V1 能力承诺、权限结果、M3+M4 real-tree mutation gate 与明确 non-goals；
13. 本页列出的全部 accepted ADR；
14. [`development-guide.md`](./development-guide.md)：环境、命令和开发流程；
15. [`contracts.md`](./contracts.md)：当前接口、事件和失败语义；
16. [`testing-strategy.md`](./testing-strategy.md)：测试与 golden 更新规则；
17. [`architecture.md`](./architecture.md) 与 [`module-design.md`](./module-design.md)：当前 Runtime Kernel 架构；
18. [`protocol/runtime-ipc-v1.md`](./protocol/runtime-ipc-v1.md)：当前 Runtime producer 与未来 Agent Platform consumer 的进程契约；
19. [`requirements-traceability.md`](./requirements-traceability.md)：原始目标与面试能力的证据边界；
20. 已完成的 P2-M1/P2-M2 实施文档与冻结评测证据。
...
| `execution-contracts/m3-execution-contract.md` | 已完成的 M3 如何限定 instructions/context/frozen request、Schema v7、精确 retry、指标与只读门禁？ |
